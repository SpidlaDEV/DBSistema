...
switch ($_GET["op"]) {
    case 'guardaryeditar':
        if (empty($idpersona)) {
            ...
            echo $rspta ? "Persona registrada" : "Se ha producido un error";
        } else {
            $rspta = $persona->editar($idpersona, $tipo_persona, $nombre, $tipo_documento, $num_documento, $direccion, $telefono, $email);
            echo $rspta ? "Datos actualizados" : "Se ha producido un error";
        }
        break;

    case 'eliminar':
        $rspta = $persona->eliminar($idpersona);
        echo $rspta ? "Persona eliminada" : "Se ha producido un error";
        break;
